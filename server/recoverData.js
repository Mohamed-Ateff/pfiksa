...
const OLD_MONGODB_URI = "mongodb://mongo:iavavQpzCnuqLhBaYIDNbGlYCMLusjPF@tramway.proxy.rlwy.net:12820/employee-reports";
const NEW_MONGODB_URI = process.env.MONGODB_URI || "mongodb://localhost:27017/employee-reports";
...
async function recoverData() {
  ...
  try {
    ...
    const NewUser = newConnection.model("User", require("./models/User").schema);
    ...
    console.log("This is normal. The lost accounts will need to be recreated or added manually.");
  } finally {
